  ...
  ({
    ...
    const barrierTypes = [
      {
        ...
        label: "Steps / Stairs",
        icon: "🪜",
        description: "Stairs or steps blocking access",
      },
      {
        id: "steep_slope",
        label: "Steep Slope",
        icon: "📈",
        description: "Path is too steep for safe travel",
      },
      {
        id: "obstructed_path",
        label: "Obstructed Path",
        icon: "🚧",
        description: "Path blocked by obstacles",
      },
      {
        id: "inaccessible_entrance",
        label: "Inaccessible Entrance",
        icon: "🚪",
        description: "No accessible entrance available",
      },
      {
        id: "no_curb_cut",
        label: "No Curb Cut",
        icon: "♿",
        description: "Missing ramp at curb",
      },
      {
        id: "poor_lighting",
        label: "Poor Lighting",
        icon: "💡",
        description: "Insufficient lighting for safety",
      },
      {
        id: "construction",
        label: "Construction",
      ...
      },
      {
        ...
        label: "Snow/Ice",
        icon: "❄️",
        description: "Snow or ice making path unsafe",
      },
      {
        id: "other",
        label: "Other",
        icon: "❓",
        description: "Other accessibility issue",
      },
    ];
    ...
    const severityLevels = [
      ...
      },
      {
        id: "medium",
        label: "Medium",
        description: "Significant barrier",
        color: "#F59E0B",
      },
      {
        id: "high",
    ...
    const getCurrentLocation = useCallback(() => {
      ...
      // OPTIMIZATION: Check if we're in a secure context (HTTPS or localhost)
      ...
      if (!isSecureContext) {
        toast.error("Location access requires HTTPS. Please enter coordinates manually or use the map to select location.");
        console.warn("Geolocation blocked: Not in secure context");
        setIsGettingLocation(false);
        return;
      }
      ...
      navigator.geolocation.getCurrentPosition(
        ...
        (error) => {
          ...
          // OPTIMIZATION: Better geolocation error handling with specific messages
          let errorMessage = "Could not detect your location. Please enter manually.";
          ...
          switch (error.code) {
            ...
            case error.TIMEOUT:
              ...
              break;
            default:
              // For HTTPS/secure origin issues
              if (error.message.includes('secure origins') || error.message.includes('HTTPS')) {
                errorMessage = "Location requires HTTPS. Please enter coordinates manually or use the map to select location.";
              }
              break;
          }
        ...
        >
          ...
          <div className="modal-content">
            ...
            <div className="progress-indicator">
              ...
              <div className="progress-step">
                <div
                  className={`step-number ${currentStep >= 4 ? "active" : ""}`}
                >
                  4
                </div>
            ...
            {currentStep === 1 && (
              <div className="step-content">
                ...
                <p>
                  Select the category that best describes the accessibility
                  issue.
                </p>
                ...
                <div className="barrier-type-grid">
                  {barrierTypes.map((type) => (
                    <button
                      ...
                      className={`barrier-type-button ${
                        formData.type === type.id ? "selected" : ""
                      }`}
                    >
                      ...
                      <div className="barrier-type-info">
                        ...
                        <span className="barrier-type-description">
                          {type.description}
                        </span>
                      </div>
                    </button>
                ...
                {/* I added this div to fix an error on mobile where the last few items will be hiddenbehind the footer, simple fix */}
                  ...
                  {severityLevels.map((level) => (
                    <button
                      ...
                      className={`severity-button ${
                        formData.severity === level.id ? "selected" : ""
                      }`}
              ...
              <div className="step-content">
                ...
                <div className="location-section">
                  ...
                  <div className="location-note">
                    <p>
                      💡 The location will be used to help other users avoid
                      this barrier and for city officials to address the issue.
                    </p>
                  </div>
                </div>
              </div>
